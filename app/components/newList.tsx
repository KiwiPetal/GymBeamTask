  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`flex flex-col bg-stone-900 p-3 rounded items-center container gap-2 lg:w-64 overflow-hidden`}>
          ...
          className="block w-full p-2 overflow-hidden text-xl font-bold rounded outline-none bg-stone-800 placeholder:text-stone-500 focus:outline-stone-500" />
        {
          itemList.map((item, i) => {
            return (
              <div key={i} className="flex flex-col w-full py-2 border-b-2 border-stone-800 gap-1">
                <div className={`flex relative flex-row justify-center items-center gap-1`}>
                  <input
                    ...
                    className="h-4 border-[1px] border-pink-900 rounded appearance-none cursor-pointer aspect-square after:content-[''] after:rounded after:absolute after:bg-pink-600 after:h-4 after:opacity-0 checked:after:opacity-100 after:transition-all after:duration-200 after:aspect-square" />
                  ...
                  <div className="relative flex items-center h-6 p-1 rounded-full cursor-pointer group hover:bg-transparent bg-stone-700 aspect-square transition-all duration-150">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} className="size-6 stroke-white group-hover:stroke-none transition-all duration-150">
                    ...
                    <div className="absolute right-0 z-10 flex flex-col gap-4 top-1/2 -translate-y-1/2 group-hover:scale-100 scale-0 transition-all duration-150 origin-right">
                      <p
                        ...
                        className="p-1 px-2 text-lg text-center rounded shadow-md active:scale-90 bg-cyan-800">
                        Properties
                      </p>
                      <p
                        onClick={() => deleteItem(item)}
                        className="p-1 px-2 text-lg text-center bg-red-800 rounded shadow-xl active:scale-90">
                        Delete
                      </p>
                    </div>
                  </div>
                ...
                <div
                  ...
                  {itemList[i].props.tags?.map((tag, _i) => {
                    return (
                      <div
                        className="relative p-1 rounded group bg-stone-800 text-stone-500"
                        key={"tag" + _i}>
                        #{tag}
                        <div
                ...
                <motion.div
                  ...
                  <input
                    ...
                    className="h-4 border-[1px] border-red-900 rounded appearance-none cursor-pointer aspect-square after:content-[''] after:rounded after:absolute after:bg-red-600 after:h-4 after:opacity-0 checked:after:opacity-100 after:transition-all after:duration-200 after:aspect-square" />
                  </label>
                  <label>
                    Details
                    <input
                      ...
                      className="block w-full h-8 p-2 rounded outline-none bg-stone-800 peer placeholder:text-stone-500 focus:outline-none" />
                  </label>
                  <label>
                    Tags
                    <input
                  ...
                  <button
                    ...
                    className="w-full p-1 mt-2 bg-green-700 rounded">
                    Confirm properties
                  </button>
                </motion.div>
              </div>
        ...
        <motion.div
          ...
          <button
            onClick={() => handleSend()}
            className={`appearance-none overflow-hidden cursor-pointer active:scale-90 w-full text-center p-2 rounded bg-pink-900`}>
            Add new list
          </button>
        </motion.div>
      </motion.div>
